...
# World atmosphere. Does not depend on person state.
WEATHER = (
    "clear",
    "overcast",
    "rain_on_roof",
...
class LifeObservedSocietyLab(SocietyLab):
    ...
    def _year_weather(self, rng: random.Random) -> str:
        """Atmosphere for the year. Does not depend on person state."""
    ...
    def _observe_life(self) -> None:
        ...
        # Record world atmosphere first, independent of the tea house.
